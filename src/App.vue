<template>
  <main id="app">
    <b-navbar toggleable="md" type="dark" variant="dark" sticky>
      <b-container>
        <b-navbar-brand to="/" @click="hideNavigation()">
          <siteName variant="short" :image="true" />
        </b-navbar-brand>

        <b-navbar-toggle target="mobile-navigation"></b-navbar-toggle>

        <b-collapse id="mobile-navigation" ref="mobileNavigation" is-nav>
          <b-navbar-nav>
            <b-nav-item class="d-none d-lg-block" to="/">Home</b-nav-item>
            <b-nav-item to="/workouts">Workouts</b-nav-item>
            <b-nav-item to="/exercises">Exercises</b-nav-item>
            <b-nav-item class="d-none d-md-block" to="/admin">Admin</b-nav-item>
          </b-navbar-nav>
        </b-collapse>
      </b-container>
    </b-navbar>
    ...
    <footer class="container-fluid p-5 mt-5">
      <b-row>
        <b-col class="text-center">
          <a href="https://github.com/catidkarrell/fitness_app" title="Workout App on Github"
